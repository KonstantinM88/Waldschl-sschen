        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 pb-16 border-b border-white/8">
          ...
          <div>
            ...
            <nav className="flex flex-col">
              ...
              <Link href={buildPageHref("/ausflugsziele")} className="text-sm font-light leading-[2.2] opacity-55 hover:opacity-100 hover:text-gold-light transition-all">{nav("destinations")}</Link>
            </nav>
          </div>
          ...
          <div>
            ...
            <nav className="flex flex-col">
              ...
              <Link href={buildPageHref("/kontakt")} className="text-sm font-light leading-[2.2] opacity-55 hover:opacity-100 hover:text-gold-light transition-all">{nav("contact")}</Link>
            </nav>
          </div>
