  ...
  return (
    ...
    >
      <div className="relative z-10 mx-auto max-w-[900px] px-5 text-center text-white sm:px-8">
        ...
        <motion.h1
          className="events-hero-title heading-display mb-4 text-[clamp(2.18rem,11.2vw,4.8rem)] leading-[0.95] sm:mb-6 sm:text-[clamp(2.8rem,6vw,5rem)]"
          {...reveal}
        ...
        <motion.p
          className="events-hero-subtitle mx-auto mb-8 max-w-[22rem] text-[0.94rem] font-light leading-relaxed sm:mb-12 sm:max-w-[680px] sm:text-[clamp(0.95rem,1.5vw,1.15rem)]"
          {...reveal}
        ...
        >
          <a href="#anfrage" className="btn-primary w-full sm:w-auto">{t("ctaInquiry")}</a>
          <a href="#hochzeit" className="btn-outline-light w-full sm:w-auto">{t("ctaWeddings")}</a>
        </motion.div>
      </div>
    </PremiumWaveFrame>
  );
          ...
          <div className="mt-12 grid grid-cols-2 gap-3 sm:grid-cols-3 sm:gap-4 lg:grid-cols-6">
            {services.map((service) => (
              <div key={service.key} className="testimonial-card group h-full">
                <div className="testimonial-card-surface min-h-0 items-center p-5 text-center sm:p-6">
                  <div className="relative z-[1] mb-4 flex h-11 w-11 items-center justify-center rounded-full bg-sand-light shadow-[inset_0_1px_0_rgba(255,255,255,0.72)] transition-colors duration-500 group-hover:bg-gold/10 sm:mb-5 sm:h-12 sm:w-12">
                    <service.Icon className="h-5 w-5 text-gold stroke-[1.5]" />
                  </div>
                  <span className="relative z-[1] text-[0.88rem] font-light leading-snug text-text-secondary sm:text-sm">
                    {t(service.key)}
                  </span>
                </div>
              </div>
...
function EventTypes() {
  ...
  const items = [
    { key: "family" as const, Icon: Users, image: "/restaurant_room_1920w.webp", aspect: "aspect-[5/4] sm:aspect-[3/4]" },
    { key: "meetings" as const, Icon: Monitor, image: "/library_room_1920w.webp", aspect: "aspect-[5/4] sm:aspect-[3/4]" },
    { key: "celebrations" as const, Icon: Heart, image: "/restaurant_terrace_1920w.webp", aspect: "aspect-[5/4] sm:aspect-[3/4]" },
  ];
                ...
                afterSheen={
                  <div className="spaces-card-overlay flex items-end p-6 sm:p-8 lg:p-10">
                    <div className="relative z-[1]">
                      ...
                      <h3 className="mb-3 font-[var(--font-display)] text-[clamp(1.45rem,6vw,2.2rem)] font-normal text-white sm:text-[clamp(1.75rem,2vw,2.2rem)]">
                        {t(`${item.key}.title`)}
                      </h3>
  ...
  const spaces = [
    {
      ...
      aspect: "aspect-[5/4] sm:aspect-[16/10] lg:aspect-auto lg:h-full min-h-[280px] sm:min-h-[320px]",
    },
    {
                  ...
                  <div className="spaces-card-overlay flex items-end p-6 sm:p-8 lg:p-10">
                    <div className="flex w-full flex-col items-start justify-between gap-5 sm:flex-row sm:items-end">
                      <div className="relative z-[1] max-w-[24rem]">
                        ...
                        <h3 className="font-[var(--font-display)] text-[clamp(1.45rem,6vw,2.25rem)] font-normal text-white sm:text-[clamp(1.7rem,2.1vw,2.25rem)]">
                          {t(`${space.key}.title`)}
                        </h3>
                      </div>
                      <div className="relative z-[1] shrink-0 rounded-full border border-white/16 bg-white/10 px-4 py-2.5 text-center backdrop-blur-sm sm:px-5 sm:py-3">
