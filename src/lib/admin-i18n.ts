  ...
  de: {
    ...
    dashboard: {
      ...
      navigation: {
        ...
        calendar: {
          label: "Kalender",
          detail: "Belegung & Anreisen",
        },
        analytics: {
          label: "Statistik",
          detail: "Umsatz & Auslastung",
        },
        vouchers: {
          label: "Gutscheine",
      ...
      feedback: {
        ...
        invalidInput: {
          ...
          description: "Bitte prufen Sie die Pflichtfelder und das Datum.",
        },
        soldOut: {
          title: "Zimmer nicht verfugbar",
          description:
            "Fur den gewahlten Zeitraum ist das Zimmer bereits ausgebucht.",
        },
        capacity: {
          title: "Belegung zu hoch",
          description: "Die Gastezahl ubersteigt die Kapazitat des Zimmers.",
        },
        error: {
          title: "Aktion fehlgeschlagen",
          description: "Es ist ein Fehler aufgetreten. Bitte erneut versuchen.",
        },
      },
      statCards: {
        contacts: {
      ...
      pages: {
        ...
        bookings: {
          ...
          detail: {
            ...
            lifecycleTitle: "Status verwalten",
            lifecycleLocked: "Fur diesen Status sind keine weiteren Schritte moglich.",
            autoCompleted: "Automatisch abgeschlossen",
            cancellationReason: "Stornogrund",
            cancelReasonPlaceholder: "Grund fur die Stornierung (optional)",
        ...
        calendar: {
          badge: "Belegungskalender",
          title: "Kalender & Verfugbarkeit",
          description:
            "Monatsubersicht der Zimmerbelegung mit Anreisen, Abreisen und freier Kapazitat pro Tag.",
          calendar: {
            title: "Belegung",
            subtitle:
              "Tippen Sie auf einen Tag fur Details. Die Farbe zeigt die Auslastung.",
            today: "Heute",
            ...
            selectDay: "Tag auswahlen, um Details zu sehen.",
            capacityLabel: "Kapazitat",
          },
        },
        newBooking: {
          badge: "Manuelle Buchung",
          title: "Buchung anlegen",
          description:
            "Reservierung fur Telefon-, E-Mail- oder Walk-in-Gaste mit automatischer Preisberechnung.",
          cta: "Neue Buchung",
          form: {
            ...
            mealPlan: "Verpflegung",
            mealPlans: {
              ROOM_ONLY: "Ohne Fruhstuck",
              BREAKFAST: "Mit Fruhstuck",
              HALF_BOARD: "Fruhstuck + Abendessen",
            },
            dogs: "Hunde",
            bicycle: "Fahrrad reservieren",
            restaurant: "Restaurant",
            restaurantPlaceholder: "z. B. 19:00",
            source: "Quelle",
            sources: {
              ADMIN: "Admin",
              PHONE: "Telefon",
            ...
            phone: "Telefon",
            guestLocale: "Sprache",
            notes: "Notiz fur den Gast",
            adminNotes: "Interne Notiz",
            adminNotesHint: "Nur intern sichtbar.",
            summary: "Zusammenfassung",
            nights: "Nachte",
            accommodation: "Ubernachtung",
            meals: "Verpflegung",
            extraBeds: "Zusatzbett",
            dogFee: "Hundezuschlag",
            total: "Gesamt",
            submit: "Buchung anlegen",
            submitting: "Wird angelegt...",
            noRooms: "Keine aktiven Zimmer vorhanden.",
            capacityWarning: "Gastezahl ubersteigt die Kapazitat des Zimmers.",
            perNight: "pro Nacht",
          },
        },
        analytics: {
          ...
          description:
            "Kennzahlen zu Belegung, Umsatz und Buchungsverhalten fur den gewahlten Zeitraum.",
          rangeLabel: "Zeitraum",
          ranges: {
            "7": "7 Tage",
            "30": "30 Tage",
          ...
          metrics: {
            ...
            kpiAdr: "ADR (Ø Rate)",
            kpiRevpar: "RevPAR",
            kpiRevenue: "Umsatz (bestatigt)",
            kpiRealized: "Realisiert",
            kpiPending: "Offen",
            kpiLeadTime: "Vorlaufzeit",
            kpiStay: "Ø Aufenthalt",
            kpiCancellation: "Stornoquote",
            kpiNoShow: "No-Show",
            kpiRoomNights: "Zimmernachte",
            days: "Tage",
            nights: "Nachte",
            revenueTitle: "Umsatz pro Monat",
            revenueEmpty: "Keine Umsatzdaten im Zeitraum.",
            sourceTitle: "Buchungsquellen",
  ...
  ru: {
    ...
    dashboard: {
      ...
      navigation: {
        ...
        calendar: {
          label: "Календарь",
          detail: "Занятость и заезды",
        },
        analytics: {
          label: "Статистика",
          detail: "Выручка и загрузка",
        },
        vouchers: {
          label: "Сертификаты",
      ...
      feedback: {
        ...
        invalidInput: {
          ...
          description: "Проверьте обязательные поля и корректность дат.",
        },
        soldOut: {
          title: "Номер недоступен",
          description: "На выбранные даты этот номер уже занят.",
        },
        capacity: {
          title: "Превышена вместимость",
          description: "Количество гостей превышает вместимость номера.",
        },
        error: {
      ...
      pages: {
        ...
        bookings: {
          ...
          detail: {
            ...
            lifecycleTitle: "Управление статусом",
            lifecycleLocked: "Для этого статуса дальнейшие действия недоступны.",
            ...
            cancelConfirm: "Точно отменить это бронирование?",
            cancel: "Отменить",
        ...
        calendar: {
          badge: "Календарь занятости",
          title: "Календарь и доступность",
          description:
            "Месячный обзор занятости номеров с заездами, выездами и свободной ёмкостью по дням.",
          calendar: {
            title: "Занятость",
            subtitle:
              "Нажмите на день, чтобы увидеть детали. Цвет показывает загрузку.",
            today: "Сегодня",
            ...
            selectDay: "Выберите день, чтобы увидеть детали.",
        ...
        newBooking: {
          ...
          description:
            "Бронь для гостей по телефону, e-mail или при заселении с автоматическим расчётом цены.",
          cta: "Новая бронь",
          form: {
            ...
            mealPlan: "Питание",
            mealPlans: {
              ROOM_ONLY: "Без завтрака",
              BREAKFAST: "С завтраком",
              HALF_BOARD: "Завтрак + ужин",
            },
            dogs: "Собаки",
            bicycle: "Зарезервировать велосипед",
            restaurant: "Ресторан",
            restaurantPlaceholder: "напр. 19:00",
            source: "Источник",
            sources: {
              ADMIN: "Админ",
              PHONE: "Телефон",
            ...
            phone: "Телефон",
            guestLocale: "Язык",
            notes: "Заметка для гостя",
            adminNotes: "Внутренняя заметка",
            adminNotesHint: "Видна только персоналу.",
            summary: "Итог",
            nights: "Ночей",
            accommodation: "Проживание",
            meals: "Питание",
            extraBeds: "Доп. кровать",
            dogFee: "Сбор за собаку",
            total: "Итого",
            submit: "Создать бронь",
            submitting: "Создание...",
            noRooms: "Нет активных номеров.",
            capacityWarning: "Количество гостей превышает вместимость номера.",
            perNight: "за ночь",
          },
        },
        analytics: {
          ...
          description:
            "Показатели занятости, выручки и поведения бронирований за выбранный период.",
          rangeLabel: "Период",
          ranges: {
            "7": "7 дней",
            "30": "30 дней",
          ...
          metrics: {
            ...
            kpiAdr: "ADR (ср. цена)",
            kpiRevpar: "RevPAR",
            kpiRevenue: "Выручка (подтв.)",
            kpiRealized: "Реализовано",
            kpiPending: "В ожидании",
            kpiLeadTime: "Срок до заезда",
            kpiStay: "Ср. проживание",
            kpiCancellation: "Доля отмен",
            kpiNoShow: "Неявки",
            kpiRoomNights: "Номеро-ночи",
            days: "дн.",
            nights: "ноч.",
            revenueTitle: "Выручка по месяцам",
            revenueEmpty: "Нет данных о выручке за период.",
            sourceTitle: "Источники броней",
            statusTitle: "Распределение статусов",
            bookings: "Брони",
          },
        },
        vouchers: {
